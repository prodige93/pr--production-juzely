...
import './hoodie-design.css';

function HoodieDesign() {
  ...
  const [editableSizeData, setEditableSizeData] = useState({
    XS: { chest: 86, length: 66, sleeve: 59 },
  ...
  useEffect(() => {
    ...
    if (selections.length > 0) {
      ...
      if (latestSelection.garmentType === 'hoodie') {
  ...
  // Handle quote generation
   const handleGenerateQuote = () => {
     try {
       ...
       console.log('Devis Hoodie généré:', quoteId, quoteData);
  ...
  return (
    <div className="hoodie-design-container">
      <div className="design-header">
        ...
        <div className="header-center">
          <div className="tabs">
            <button className="tab active">Hoodie</button>
          </div>
        </div>
