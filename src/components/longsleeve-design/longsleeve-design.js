...
import './longsleeve-design.css';

function LongsleeveDesign() {
  ...
  const [editableSizeData, setEditableSizeData] = useState({
    XS: { chest: 84, length: 62, sleeve: 60 },
    S: { chest: 89, length: 65, sleeve: 62 },
    M: { chest: 94, length: 68, sleeve: 64 },
    L: { chest: 99, length: 71, sleeve: 66 },
    XL: { chest: 104, length: 74, sleeve: 68 },
    XXL: { chest: 109, length: 77, sleeve: 70 }
  });
  ...
  useEffect(() => {
    ...
    if (selections.length > 0) {
      ...
      if (latestSelection.garmentType === 'longsleeve') {
  ...
  // Handle quote generation
   const handleGenerateQuote = () => {
     try {
       ...
       console.log('Devis Long Sleeve généré:', quoteId, quoteData);
  ...
  return (
    <div className="longsleeve-design-container">
      <div className="design-header">
        ...
        <div className="header-center">
          <div className="tabs">
            <button className="tab active">Long Sleeve</button>
          </div>
        </div>
...
export default LongsleeveDesign;